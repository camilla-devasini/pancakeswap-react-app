import due from '../../../assets/images/homepage/2@2x.webp';
import quattro from '../../../assets/images/homepage/4@2x.webp'
import sei from '../../../assets/images/homepage/6@2x.webp'
import sette from '../../../assets/images/homepage/7@2x.webp'
import nove from '../../../assets/images/homepage/9@2x.webp'
import card1 from '../../../assets/images/homepage/green@2x.webp'
import card2 from '../../../assets/images/homepage/red@2x.webp'
import card3 from '../../../assets/images/homepage/top-right@2x.webp'
import card4 from '../../../assets/images/homepage/bottom-left@2x.webp'
    ...
    return (
        <div>
            <section className='container-5'>
                <picture className="balls">
                    <img className="prima" src={due} alt="" />
                    <img className="seconda" src={quattro} alt="" />
                    <img className="terza" src={sei} alt="" />
                    <img className="quarta" src={sette} alt="" />
                    <img className="quinta" src={nove} alt="" />
                </picture>
                ...
                <div className="box-wrapper">
                    ...
                    <div className="millions-in-prizes-cards">
                        <div className="card-million yellow">
                            ...
                            <button>Play
                                <svg viewBox="0 0 24 24" color="invertedContrast" width="20px"
                                    xmlns="http://www.w3.org/2000/svg" className="sc-6457768a-0 ftixwH">
                                    <path
                            ...
                            <div className="svg">
                                <svg viewBox="0 0 24 24" width="36px" color="inverseContrast" xmlns="http://www.w3.org/2000/svg"
                                    className="sc-6457768a-0 bepwKD">
                                    <path
                        ...
                        <div className="card-million purple">
                            ...
                            <div className="svg">
                                <svg viewBox="0 0 24 24" color="white" width="36px" xmlns="http://www.w3.org/2000/svg"
                                    className="sc-6457768a-0 gPdkze">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
