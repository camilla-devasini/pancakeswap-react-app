...
function ConnectWallet(props) {
    ...
    return (
        <div className="main-container-wallet">
           <header>
                <button onClick={backToConnect}className="btn-violet-on-white">Connect Wallet</button>
                <button onClick={showLearnHandler} className="btn-white-on-violet">What's a Web3 Wallet?</button>
            </header>
